...
- Visuals: shot catalog + R2 renders in the [djseith pipeline repo](https://github.com/seith-miller/djseith)
...
- [research/](../research/) — competitive scan of the DJ Mag Top-100 top-10's personal sites (screenshots + common traits)
